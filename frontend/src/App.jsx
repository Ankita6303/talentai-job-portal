      ...
      <div style={{ background:"#0c1220", border:"1px solid #1e293b", borderRadius:18,
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:10, marginBottom:16 }}>
          {[
            ...
            <div key={i.label} style={{ background:"#0f172a", borderRadius:8, padding:"10px 12px",
            ...
            <div>
              ...
              <label style={{ display:"flex", flexDirection:"column", alignItems:"center",
                ...
                {file
                  ...
                  : <>
                      <span style={{ fontSize:13, color:"#475569", fontWeight:600 }}>Click to upload PDF, TXT, or MD</span>
    ...
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center",
      ...
      <div style={{ width:380, background:"#0c1220", border:"1px solid #1e293b",
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
          ...
          {err && (
            <p style={{ fontSize:13, color:"#f87171", padding:"8px 12px",
              background:"#7f1d1d22", borderRadius:6 }}>{err}</p>
          )}
...
function JobsView() {
  ...
  if (loading) return (
    <div style={{ textAlign:"center", padding:60, color:"#475569" }}>
      <Spinner/>
      <p style={{ marginTop:12, fontSize:14 }}>Loading jobs…</p>
    </div>
  );
  ...
  if (err) return (
    <div style={{ textAlign:"center", padding:60, color:"#f87171" }}>
      <p>⚠️ {err}</p>
      <p style={{ fontSize:12, marginTop:6, color:"#64748b" }}>Is the backend running?</p>
    </div>
  );
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
          {filtered.length === 0 && (
            <div style={{ textAlign:"center", padding:"40px 20px", color:"#475569" }}>
              ...
              <p style={{ fontSize:14 }}>No jobs posted yet. Ask your admin to post some!</p>
            </div>
          )}
          {filtered.map(j=>{
    ...
    <div style={{ minHeight:"100vh", background:"#070d1a", color:"#f1f5f9",
      ...
      <div style={{ background:"#0c1220", borderBottom:"1px solid #1e293b", padding:"0 28px" }}>
        <div style={{ maxWidth:1100, margin:"0 auto", display:"flex",
          alignItems:"center", height:56, gap:20 }}>
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
